  ...
  return (
    ...
    >
      ...
      >
        ...
        {/* Opening date, in Tashkent time — the schedule the game goes by. */}
        {data.opens_at && (
          <span
            className={`flex items-center gap-2 rounded-lg border px-3 py-1.5 font-mono text-xs tracking-wide ${
              isScheduled
